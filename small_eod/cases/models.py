...
class Case(TimeStampedModel):
    ...
    responsible_people = models.ManyToManyField(
        to="cases.Person", blank=True, verbose_name=_("Responsble person")
    )
...
class Person(TimeStampedModel):
    ...
    user = models.ForeignKey(
        to=settings.AUTH_USER_MODEL, null=True, blank=True, on_delete=models.CASCADE
    )
...
class Letter(TimeStampedModel):
    ...
    name = models.ForeignKey(
        to="cases.LetterName", verbose_name=_("Description"), on_delete=models.CASCADE
    )
