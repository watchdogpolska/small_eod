...
user_router.register('responsibleUser', ResponsibleUserViewSet, basename='cases-responsible_user')
user_router.register(r'notifiedUser', NotifiedUserViewSet, basename='cases-notified_user')
