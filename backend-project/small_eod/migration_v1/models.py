...
class Person(TimeStampedModel):
    ...
    user = models.ForeignKey(
        to=settings.AUTH_USER_MODEL, null=True, blank=True, on_delete=models.DO_NOTHING
    )
...
class Case(TimeStampedModel):
    ...
    responsible_people = models.ManyToManyField(
        to=Person, blank=True, verbose_name=_("Responsble person")
    )
    tags = models.ManyToManyField(to=Tag, verbose_name=_("Tags"), blank=True)
    ...
    whose_case = models.ManyToManyField(
        to=Dictionary,
    ...
    what_scope = models.ManyToManyField(
        to=Dictionary,
    ...
    inaction_scope = models.ManyToManyField(
        to=Dictionary,
    ...
    decision_scope = models.ManyToManyField(
        to=Dictionary,
    ...
    time_of_info_provide = models.ManyToManyField(
        to=Dictionary,
    ...
    proceddings_interrupted = models.ManyToManyField(
        to=Dictionary,
...
class Letter(TimeStampedModel):
    DIRECTION = (("R", _("received")), ("S", _("send")))
    name = models.ForeignKey(
        to=LetterName, verbose_name=_("Description"), on_delete=models.CASCADE
    )
    ...
    identifier = models.CharField(
        max_length=100, verbose_name=_("Identifier"), blank=True
    )
    ...
    attachment = models.FileField(
        verbose_name=_("Attachment"), blank=True, max_length=254
    )
